<template>
	<view class="container">
		...
		<uni-section title="个人资料" type="line">
			<uni-card :is-shadow="false">
				<uni-forms ref="baseForm" :modelValue="options">
					<uni-forms-item label="用户名:"><uni-easyinput v-model="options.username"
							:disabled="true" /></uni-forms-item>
					<uni-forms-item label="姓 名:"><uni-easyinput v-model="options.trueName"
							:disabled="editFlag" /></uni-forms-item>
					<uni-forms-item label="手机号:"><uni-easyinput v-model="options.phone"
							:disabled="editFlag" /></uni-forms-item>
					<uni-forms-item label="身 份:"><uni-easyinput v-model="this.roles"
							:disabled="true" /></uni-forms-item>
					<uni-forms-item label="邮 箱:"><uni-easyinput v-model="options.email"
							:disabled="editFlag" /></uni-forms-item>
					<uni-forms-item label="居住地:"><uni-easyinput v-model="options.city"
							:disabled="editFlag" /></uni-forms-item>
					<uni-forms-item label="创 建:"><uni-easyinput v-model="createTime"
							:disabled="true" /></uni-forms-item>
		...
		<view class="btn-class" v-if="editFlag"><button class="button" type="primary" @click="editInfo()">编辑资料</button>
		</view>
		<view class="btn-class" v-else><button class="button" type="default"
				style="background-color: green;color: white;" @click="saveInfo()">保存资料</button></view>
	</view>
</template>
